...
\begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth,trim=0mm 5mm 0mm 5mm,clip,page=1]{../simulations/pics/Mode.pdf}
    \caption{}
\end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth,trim=0mm 5mm 0mm 5mm,clip,page=2]{../simulations/pics/Mode.pdf}
    \caption{}
\end{subfigure}
\caption{MSE for the number of PCs chosen by each method, as a fold increase from the optimal MSE.
Each point represents the result for single simulation iteration for each combination of parameters.}
\label{fig:all}
\end{figure}
