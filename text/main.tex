...
\begin{figure}
\begin{center}
    \includegraphics[height=2.8in,trim=0mm 5mm 10mm 5mm,clip,page=3]{../simulations/pics/Noise.pdf}
    \includegraphics[height=2.8in,trim=25mm 5mm 10mm 5mm,clip,page=2]{../simulations/pics/Noise.pdf}
    \includegraphics[height=2.8in,trim=25mm 5mm 10mm 5mm,clip,page=1]{../simulations/pics/Noise.pdf}
\end{center}
...
\begin{subfigure}[b]{\textwidth}
    \includegraphics[height=2.8in,trim=0mm 5mm 10mm 5mm,clip,page=1]{../simulations/pics/Bio.pdf}
    \includegraphics[height=2.8in,trim=25mm 5mm 10mm 5mm,clip,page=2]{../simulations/pics/Bio.pdf}
    \includegraphics[height=2.8in,trim=25mm 5mm 10mm 5mm,clip,page=3]{../simulations/pics/Bio.pdf}
\caption{}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
    \includegraphics[height=2.8in,trim=0mm 5mm 10mm 5mm,clip,page=1]{../simulations/pics/Prop_DE.pdf}
    \includegraphics[height=2.8in,trim=25mm 5mm 10mm 5mm,clip,page=2]{../simulations/pics/Prop_DE.pdf}
    \includegraphics[height=2.8in,trim=25mm 5mm 10mm 5mm,clip,page=3]{../simulations/pics/Prop_DE.pdf}
\caption{}
\end{subfigure}
...
% Also ensures that $E(\mathbf{Y}) = \mathbf{\tilde Z}_{(s)}$;
...
\section{Discussion}
Performance aside, it is worth considering the practicalities involved in the use of each method.
...
Elbow detection is the simplest method as it does not use the noise magnitude or permutations,
though the choice of elbow location can be arbitrary in data sets with weak signal.
