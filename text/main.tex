...
The jackstraw method also performs well, recovering the optimal MSE more frequently than summation but also exhibiting larger maximum MSEs.
...
Parallel analysis recovers the optimal MSE most often but has even larger maximum MSEs compared to the jackstraw.
This is attributable to the randomness of permuting observations across an entire matrix.
